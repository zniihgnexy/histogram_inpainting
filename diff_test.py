...
# 添加 `thirdparty/DiffusionEdge` 目录到 Python 搜索路径
thirdparty_path = os.path.join(current_dir, "thirdparty", "DiffusionEdge")
sys.path.append(thirdparty_path)

# 现在尝试导入
from denoising_diffusion_pytorch.data import *
# from thirdparty.DiffusionEdge.denoising_diffusion_pytorch.data import *
# from denoising_diffusion_pytorch.data import *
